...
//             ...JSON.parse(turfToEdit.availability),
//             dateSpecificUnavailable: JSON.parse(turfToEdit.availability).dateSpecificUnavailable || [],
//             unavailableSlots: JSON.parse(turfToEdit.availability).unavailableSlots || []
//           };
//         } catch (error) {
//           console.error('Error parsing availability:', error);
//           availability = DEFAULT_AVAILABILITY;
...
//           dateSpecificUnavailable: turfToEdit.availability.dateSpecificUnavailable || [],
//           unavailableSlots: turfToEdit.availability.unavailableSlots || []
//         };
//       }
...
//       // Handle images
//       if (turfToEdit.images && Array.isArray(turfToEdit.images)) {
//         const turfImages = turfToEdit.images.filter(img => typeof img === 'string') as string[];
//         setExistingImages(turfImages);
//         setPreviewImages(turfImages);
//       }
//     } else {
//       reset({
//         availability: DEFAULT_AVAILABILITY,
...
//   const validateCurrentStep = async (): Promise<boolean> => {
//     let fieldsToValidate: (keyof TurfFormInputs)[] = [];
...
//       // Handle availability with proper typing
//       const availability: Availability = {
//         days: data.availability.days,
//         startTime: data.availability.startTime,
//         endTime: data.availability.endTime,
//         unavailableSlots: data.availability.unavailableSlots || [],
//         dateSpecificUnavailable: data.availability.dateSpecificUnavailable || []
//       };
//       formData.append('availability', JSON.stringify(availability));
...
//       onClose();
//     } catch (error) {
//   let errorMessage = 'Failed to save turf';
