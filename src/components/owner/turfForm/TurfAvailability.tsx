...
//     control, 
//     name: 'availability.regular.days' 
//   }) || ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  
//   const unavailableSlots = useWatch({ 
//     control, 
...
//             <p className="mt-1 text-sm text-red-600 flex items-center">
//               <FiAlertCircle className="mr-1" /> {errors.availability.regular.days.message}
//             </p>
//           )}
//         </div>
...
//               <p className="mt-1 text-sm text-red-600 flex items-center">
//                 <FiAlertCircle className="mr-1" /> {errors.availability.regular.startTime.message}
//               </p>
//             )}
//           </div>
//           <div>
...
//               <p className="mt-1 text-sm text-red-600 flex items-center">
//                 <FiAlertCircle className="mr-1" /> {errors.availability.regular.endTime.message}
//               </p>
//             )}
//           </div>
//         </div>
    ...
    <div className="space-y-6">
      ...
      {!isUnderMaintenance && (
        <>
          ...
          {/* Booked Slots Display (Read-only) */}
          {bookedSlot.length > 0 && (
