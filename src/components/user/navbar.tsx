...
const Navbar: React.FC<NavbarProps> = ({ className = "" }) => {
  ...
  const toggleNotifications = () => setIsNotificationOpen(!isNotificationOpen); // New function
  const closeModal = () => setIsModalOpen(false);
  const closeNotifications = () => setIsNotificationOpen(false); // New function

  const { bookings, user } = useAppSelector((state) => state.user);
  ...
  return (
    <>
      <nav className={`w-full h-16 ${className} bg-[#FEFFFA] relative z-30`}>
            ...
            <div className="hidden md:block">
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <div className="relative">
                  ...
                  {/* Profile Dropdown */}
                  {isProfileOpen && (
                    <div className="profile-dropdown absolute right-0 mt-2 w-48 bg-[#00423D] rounded-md shadow-lg py-1 z-50 border border-[#415C41] list-none">
                      <Link
                        href="/home/profile"
