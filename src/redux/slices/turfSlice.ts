...
// import { addTurf, fetchTurfs, updateTurf, deleteTurf ,markSlotUnavailable,removeUnavailableSlot} from '../actions/turfActions';
...
//     state.error = null;
//   })
//   .addCase(markSlotUnavailable.fulfilled, (state, action: PayloadAction<TurfData>) => {
//     state.loading = false;
//     const index = state.turfs.findIndex(t => t._id === action.payload._id);
//     if (index !== -1) {
//       state.turfs[index] = action.payload;
//     }
//   })
//   .addCase(markSlotUnavailable.rejected, (state, action: PayloadAction<any>) => {
//     state.loading = false;
//     state.error = action.payload?.message ?? 'Failed to mark slot unavailable';
//   })
  
//   .addCase(removeUnavailableSlot.pending, (state) => {
//     state.loading = true;
//     state.error = null;
//   })
//   .addCase(removeUnavailableSlot.fulfilled, (state, action: PayloadAction<TurfData>) => {
//     state.loading = false;
//     const index = state.turfs.findIndex(t => t._id === action.payload._id);
//     if (index !== -1) {
//       state.turfs[index] = action.payload;
//     }
//   })
//   .addCase(removeUnavailableSlot.rejected, (state, action: PayloadAction<any>) => {
//     state.loading = false;
//     state.error = action.payload?.message ?? 'Failed to remove unavailable slot';
//   });
//   },
// });
