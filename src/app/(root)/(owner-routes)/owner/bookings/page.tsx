...
//       try {
//         if (user?.id) {
//           await dispatch(fetchTurfs({ ownerId: user.id,page: 1, limit: 6}));
//         }
//       } catch (error) {
...
//       dispatch(fetchTurfs({ ownerId: user.id ,page: 1,limit: 6}));
//     }
...
const BookingsPage = () => {
  ...
  const filteredBookings = allBookings.filter((booking) => {
  // Handle the case where userId might be a string or null
